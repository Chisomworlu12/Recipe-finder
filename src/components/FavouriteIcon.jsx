export default function AddToFavourite({onToggleFavorite, recipe,isFavourite}){
    ...
    return <div  className="absolute right-3" onClick={handleFavoriteClick}><svg  className={`w-5 h-5 transition-colors ${
